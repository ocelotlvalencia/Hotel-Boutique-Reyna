        ...
        <div id="carouselExampleControls5" class="carousel slide" data-bs-ride="carousel">    
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="imagenes/hb_lux12.jpg" class="d-block w-100">
                </div>
                <div class="carousel-item">
                    <img src="imagenes/hb_lux13.jpg" class="d-block w-100">
                </div>
                <div class="carousel-item">
                    <img src="imagenes/imag31.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
        ...
        <section class = "hotel_concepto" id = "hotel_concepto">
            <div class = "sec-width2">
                <div class = "title_room text-center">
                    <h3 class="title2" style="color: black;">HABITACIÓN DELUXE 1 QUEEN</h3>
                </div>
                    <div class = "hotel-container">
                        <!-- single customer -->
                        <div class = "hotel_con">
                            <p>Habitación confortable con un toque de elegancia, donde tu estancia será mas increíble, mágica, memoriable e irrepetible. Se trata de una habitación diseñada para dos personas, ubicada en el primer piso. Para comodidad de nuestros huespedes, hemos incluido televisión, teléfono, acceso a internet, servicio a la habitación y baño privado con regadera, entre otros servicios. 
                            </p>
                        </div>
                        <br>
                        <br>
                                    ...
                                    <div class="col">
                                        <h6>SERVICIOS EN LA HABITACIÓN</h6><br>
                                            <ul class="fa-ul" style="font-weight: lighter;">
                                                <li><span class="fa-li"><i class="fa-solid fa-bed"></i></span>Una cama queen size</li>
