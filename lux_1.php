...
<html lang="es">
    ...
    <div id="carouselExampleControls5" class="carousel slide" data-bs-ride="carousel">    <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="imagenes/hb_lux4.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
                <img src="imagenes/hb_lux6.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
                <img src="imagenes/hb_lux7.jpg" class="d-block w-100">
            </div>
        </div>
    ...
    <section class = "hotel_concepto" id = "hotel_concepto">
        <div class = "sec-width2">
            <div class = "title_room text-center">
                <h3 class="title2" style="color: black;">HABITACIÓN DELUXE 1 KING</h3>
            </div>
                <div class = "hotel-container">
                    <!-- single customer -->
                    <div class = "hotel_con">
                        <p>Gran habitación con cama king size, con una decoración exquisita y elegante, con detalles contemporáneos, lo que crea un ambiente armonioso y relajante para los huéspedes. La habitación se encuentra en el primer piso, donde está especialmente diseñada para momentos especiales y estancias tranquilas. Cuenta con una televisión, acceso a internet, servicios básicos a la habitación, baño privado, aseo, ropa de cama, toallas, artículos de aseo y mobiliario de madera bellamente trabajada.
                        </p>
                    </div>
                    <br>
                    <br>
                                    ...
                                    <div class="col">
                                        <h6>SERVICIOS EN LA HABITACIÓN</h6><br>
                                            <ul class="fa-ul" style="font-weight: lighter;">
                                                <li><span class="fa-li"><i class="fa-solid fa-bed"></i></span>Una cama king size</li>
