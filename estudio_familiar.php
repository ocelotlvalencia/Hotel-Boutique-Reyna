...
<div id="carouselExampleControls5" class="carousel slide" data-bs-ride="carousel">    
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="imagenes/hb_lux8.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
                <img src="imagenes/hb_lux10.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
                <img src="imagenes/hb_lux11.jpg" class="d-block w-100">
            </div>
        </div>
    ...
    <section class="hotel_concepto" id="hotel_concepto">
            <div class="sec-width2">
                    <div class="title_room text-center">
                        <h3 class="title2" style="color: black;">ESTUDIO FAMILIAR</h3>
                    </div>
                        <div class="hotel-container">
                            <!-- single customer -->
                            <div class="hotel_con">
                                <p>Una habitación amplia, cuidadosamente decorada, diseñada para relajarse y disfrutar completamente de los servicios que ofrece el hotel durante su estadía. La habitación cuenta con acceso a ventana, por lo que tendrán cálida y maravillosa vista al jardín. También cuenta con hermosos muebles de madera, donde incluye dos camas matrimoniales, una cama individual, una televisión, acceso a internet, servicios básicos a la habitación, baño privado, aseo, ropa de cama, toallas y artículos de aseo.
                                </p>
                            </div>
                            <br>
                            <br>
                                        ...
                                        <div class="col">
                                            <h6>SERVICIOS EN LA HABITACIÓN</h6><br>
                                                <ul class="fa-ul" style="font-weight: lighter;">
                                                    ...
                                                    <li><span class="fa-li"><i class="fa-solid fa-bed"></i></span>Una cama individual</li>
                                                    <li><span class="fa-li"><i class="fas fa-couch"></i></span>Un sofá cama</li>
